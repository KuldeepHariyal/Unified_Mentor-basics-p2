...
const certificateImageContainer = document.getElementById("certificateImageContainer");
const closeModal = document.getElementById("closeModal");

// Function to open modal with certificate image
function openCertificateModal(certificateSrc) {
  certificateImageContainer.innerHTML = `<img src="${certificateSrc}" alt="Certificate Image" />`;
...
// Event listener for clicking on certificate image
document.querySelectorAll(".c-images img").forEach(img => {
